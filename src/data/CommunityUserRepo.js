...
exports.getCommunityUser = exports.createCommunityUser = void 0;
var knex_provider_1 = __importDefault(require("./knex-provider"));
var createCommunityUser = function (_a) {
    var userId = _a.userId, communityId = _a.communityId;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    knex = _b.sent();
                    return [4 /*yield*/, knex("communitiesUsers").insert({
                            userId: userId,
...
exports.createCommunityUser = createCommunityUser;
var getCommunityUser = function (_a) {
    var userId = _a.userId, communityId = _a.communityId;
    return __awaiter(void 0, void 0, void 0, function () {
        var knex;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    knex = _b.sent();
                    return [2 /*return*/, knex("communitiesUsers")
                            .where({
                            userId: userId,
                            communityId: communityId,
                        })
...
exports.getCommunityUser = getCommunityUser;
