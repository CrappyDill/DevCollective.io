...
exports.default = (function () {
    passport_1.default.use("local", new passport_local_1.Strategy(function (username, password, done) {
        return __awaiter(this, void 0, void 0, function () {
            var FAILURE_MESSAGE, user, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        FAILURE_MESSAGE = "No matching username or password found!";
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, UserService_1.checkPassword({
                                email: username,
                                password: password,
                            })];
                    case 2:
                    ...
                    case 3:
                        e_1 = _a.sent();
                        console.error("Error duing login: ", e_1);
                        done(FAILURE_MESSAGE);
                        return [3 /*break*/, 4];
