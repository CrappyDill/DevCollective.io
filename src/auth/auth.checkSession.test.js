...
describe("Check Session", function () {
    ...
    describe("sunny", function () {
        it("accurately reports during /auth/check that a logged-out user is logged-out", function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, tm.check().expect(401)];
            });
        }); });
        it("can successfully check its own sessions", function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a, firstName, lastName, email, loginResponse, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        response = _b.sent();
                        expect(response.body).toMatchObject({ firstName: firstName, lastName: lastName, email: email });
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("rainy", function () {
        it("gets 401 when checking without logged in", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tm.check()];
                    case 1:
                        response = _a.sent();
